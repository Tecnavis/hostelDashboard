...
export function OwnerNotifications({ variant = "admin" }) {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useGetAllnotficationOwnerUnReadQuery(ownerId, {
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[380px]">
        ...
        <DropdownMenuItem
          ...
          asChild
        >
          <NavLink to={`/owner/notifications`}>View all notifications</NavLink>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
